# server/ADA_Online.py (Revised: Plugin System Integration)
import asyncio
import base64
import torch
...
class ADA:
    def __init__(self, socketio_instance=None, client_sid=None):
        ...
        # Load plugins and get their functions
        self.plugins = plugin_manager.load_plugins()
        
        # Map function names to actual methods (core functions + plugin functions)
        ...
        for plugin in self.plugins.values():
            for func_info in plugin.get_functions():
                ...
                self.available_functions[func_name] = lambda plugin=plugin, func_name=func_name, **kwargs: \
